...
- 使用包含硬门槛的100分候选量表，避免每天凭感觉选择项目。
- 使用100分成稿量表验收文章，低于85分时修订或降级。
- 区分仓库事实、分析推断和借鉴建议。
- 将借鉴点映射到当前雷达系统，明确收益、成本、风险与验收标准。
...
data/evaluations/              候选项目与成稿的可审计评分卡
...
评分标准见 [`evaluation-rubric.md`](skills/github-project-radar/references/evaluation-rubric.md)。评分卡可以用以下命令复算与校验：
