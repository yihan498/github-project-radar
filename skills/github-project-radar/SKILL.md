...
8. Read `references/analysis-guide.md` and `references/collaboration-profile.md`. Write `<workspace>/reports/YYYY-MM-DD/owner--repo-v1.md`, targeting 8,000–12,000 Chinese characters unless explicitly overridden.
